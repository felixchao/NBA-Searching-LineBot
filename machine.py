...
def create_machine():
  machine = TocMachine(
    ...
    transitions=[
        ...
        {
            "trigger": "advance",
            "source": ["leader","rebound","steal","block","assist"],
            "dest": "point",
            "conditions": "is_going_to_point",
        },
        {
            "trigger": "advance",
            "source": ["leader","point","steal","block","assist"],
            "dest": "rebound",
            "conditions": "is_going_to_rebound",
        },
        {
            "trigger": "advance",
            "source": ["leader","point","steal","rebound","block"],
            "dest": "assist",
            "conditions": "is_going_to_assist",
        },
        {
            "trigger": "advance",
            "source": ["leader","point","assist","rebound","block"],
            "dest": "steal",
            "conditions": "is_going_to_steal",
        },
        {
            "trigger": "advance",
            "source": ["leader","point","assist","rebound","steal"],
            "dest": "block",
